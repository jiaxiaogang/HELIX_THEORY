...
| --- | --- | --- | --- | --- |
| 1. 潜 | 感知输入外界的信息，直接或间接触发了注意力 | iit | 入多出少（认知入也有显意识，如痛感） | 被动多主动少 |
| 2. 显 | 意向性为开端，对自身信息的有效组织与行为输出 | gnw | 出多入少（决策出也有潜意识，如求解） | 主动多被动少 |
...
### 3.2 意识模型：
* 内部循环：感性价值的升降变化（饿感，痛感等）。
* 中部循环：思维与知识的循环。
* 外部循环：智能体与现实世界的循环。
* 示例步骤：
  * 步骤1、因为外界环境带来负熵能量输入（如吃苹果）。
  * 步骤2、身体将其变成正价值感（甜和不饿信号）。
  * 步骤3、因此思维将相关信息学习记住（苹果概念，食用用法，防饿作用）。
  * 步骤4、下次饥饿时会运用这个知识从现实世界找苹果解决饥饿问题。
...
1. 从无到有：表达意识是主观感受。
   - 在此角度万物有灵是ok的，主观上认为自己活着。
2. 从少到多：表达意识太弱没意义，要通过认知需求决策等来表现出更多意识。
   - 即全局空间理论中体现出更多意识，与外界的交互入（认知）、用（需求）、出（决策）。
3. 意识充足：表达意识要足够强。
   - 通过螺旋式的良性循环，使意识足够自由和逐步成长增强。

> 附注：宏观能体现出微观没有的特性：即复杂系统整体上体现出的特性通过微观视角都是无法查到的，比如中医里的经络，有，但解剖又发现不了。
...
1. 智能的定义之：收集线索。
   - 一、螺旋论中客观的前提（环境条件）。
   - 二、再加上螺旋论中主观的部分（智能体是熵减的 & 智能是主观的）摘出来。
   - 三、然后再加上:`2-模型`中的体现(达到目标)。
2. 智能的定义：`智能是在正负熵环境中，解决自身目标的能力`;
