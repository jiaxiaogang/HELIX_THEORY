...
![](../手稿/assets/244_外层死循环BUG解决方式示图.png)

　　并且反思的复杂度也因重组RTAlg和RTFo，导致越来越难以控制，如下图：

![](../手稿/assets/245_反思学习示图方案1.png)
![](../手稿/assets/246_反思学习示图方案2.png)
...
源手稿：[点击查看](../手稿/Note19.md#n19p10-mc_alg算法迭代v3)
