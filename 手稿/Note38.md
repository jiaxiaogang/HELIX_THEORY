...
- [强训Mnist竞争浮现](#强训mnist竞争浮现)
  ...
  - [n38p03 ST竞争：准确为主数量为辅 & 外形为主内征为辅](#n38p03-st竞争准确为主数量为辅--外形为主内征为辅)
...
**38032-准确为主数量为辅 & 外形为主内征为辅：实践TODOLIST**
...
* TODO3：1、外形过滤80% 2、内征过滤80% 3、最后按匹配数排序 => 得到最终识别结果。
