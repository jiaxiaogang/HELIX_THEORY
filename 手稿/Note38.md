...
* BUG1：训练40轮后，，，扔个0识别。
  ...
  - 问题：全是T50-T220之间的很早期的T，甚至像T59这种外形只有18%匹配的，也能战胜（因为稳定性高）。
  - 解决：如果稳定性是强者恒强影响到准确性了，那么就可以降低它的权重或者机制，比如：改成末尾淘汰，不能喧宾夺主。
  - 回顾：原来的末尾淘汰前面刚取消掉（当时的原因是多项都淘汰时淘汰率就太高了）。
  - TODO：改为把前80%竞争分全设为1，末尾20%竞争分保持原状，然后继续正常进行综合T结果竞争淘汰即可 `T`。
