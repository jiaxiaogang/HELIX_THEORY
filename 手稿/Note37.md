...
- [特征识别测试细节修进](#特征识别测试细节修进)
  ...
  - [n37p04 连续视觉-专注循环](#n37p04-连续视觉-专注循环)
  ...
  - [n37p10 特征识别优化：连续视觉-专注循环2](#n37p10-特征识别优化连续视觉-专注循环2)
...
| TODO2 | 竞争后的识别结果，继续递归调用dotSize.while三个粒度层，再竞争结果。 |
| TODO3 | 最多递归两三次即可，将所有递归调用中的结果全收集起来。 |
