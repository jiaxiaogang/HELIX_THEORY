...
- [去皮训练: 学去皮](#去皮训练-学去皮)
  ...
  - [n31p07 Canset竞争实时响应变化](#n31p07-canset竞争实时响应变化)
...
## n31p07 Canset竞争实时响应变化
`CreateTime 2024.01.18`

上节仅仅接受RCansetA的持续反馈,和对每次反馈进行评价的方式不够彻底,本节转向更加彻底的方式: Canset候选集竞争实时响应变化;

| 31071 | Canset竞争实时响应变化: 缘起 |
| --- | --- |
