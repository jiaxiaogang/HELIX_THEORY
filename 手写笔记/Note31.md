...
| TODO1 | frameActYes无反馈时,在31176中传染的基础上,向整个工作记忆树上传染; |
| TODO2 | feedbackTOR有反馈时,被传染的支持整个工作记忆树重生; |
| TODO3 | 在rSolution/hSolution初始化Canset池时,也继用下传染状态; |
| TODO4 | 已被传染的Canset不会激活,直接计为不可行; |
