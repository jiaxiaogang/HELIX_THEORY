...
RCanset预想与实际类比:F9029[A13(饿16,7),A515(距32,向72,皮果),飞↑] (curS:F8938 状态:Runing fromPFo:F518 帧:2)
RCanset预想与实际类比:F9267[A13(饿16,7),A515(距32,向72,皮果),A9266(距23,棒),飞↑] (curS:F8938 状态:Runing fromPFo:F518 帧:2)
RCanset预想与实际类比:F9303[A13(饿16,7),A515(距32,向72,皮果),A9302(向88,棒),飞↑] (curS:F8938 状态:Runing fromPFo:F518 帧:2)
//说明: 从以上日志可见，确实可以得到“交层无距棒”，但还没能得到“交层无皮果”，明天再测...
```

| 3101x | 搬运动机追加训练步骤6 |
| --- | --- |
| 简介 | 在31011分析了搬运动机的实现思路,本表追加实际的训练步骤6,来试下; |
| 步骤6 | **搬运动机: 在FZ895基础上再跑跑步骤4** `参考31011-原则&测下` =>存为FZ896; |
|  | > 重点日志: 看下`rCanset有没有增强SP`; |
