...
| 结果 | 方案1执行完成,TODO=>重新训练FZ30,看还有没问题; |
...
| 思考 | 当汽车撞过来前,我们看了三次,那么预测会被撞疼几次?为什么是1次? |
| 思考 | 当车追车鸟撞,鸟边逃边回头看车,那么: |
|  | 1. 每次看车,当前场景F不变的情况下,任务推进变化了,原旧的IRT预测应失效 |
|  | 2. 每次看车,每条IRT预测都是独立的,即使还未最终摆脱危险,前面的IRT也应该算做P结束了; |
|  | > 如果这条ok,那么当前的多次IRT是正常的,而因此产生了P的Y距35也是正常的; |
