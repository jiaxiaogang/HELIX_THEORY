...
| 问题 | **如何选出最优路径?** |
| 1 | 同层间,Solution多选一,而Demand全算数; |
| 2 | 每一个枝点的综评,都是将其下线所有路径之间pk出最优; |
...
| 分析2 | 可能末评位置无子任务,即执行不到新子任务 `正常,菜再好我也只爱肉`; |
...
| 结果 | A和B统一成为末评pk,即AB一体不存在协作,本表`作废`; |

| 24187 | 统一为末评pk后: 末枝反馈更新问题 |
| --- | --- |
