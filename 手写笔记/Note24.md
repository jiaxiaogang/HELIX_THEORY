...
| 方案1 | 当主线程卡住时,使触发器触发时间顺延; |
|  | 简单偷懒方案: 主线程卡住时,触发器时间顺延等待,卡的时间不算数; |
| 方案2 | 现实世界不等人,使思维控制不应占用UI线程; |
|  | 此方案需结合方案3,不然TC还卡着,UI却撞死乌鸦了; |
| 方案3 | 解决TC性能: 看紧急情况进行反思,避免紧急时还在反思卡着; |
|  | 情况1: 紧急=>例如为躲糜鹿,车撞护栏 |
