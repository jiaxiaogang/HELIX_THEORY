...
- [废弃HN & 分裂:理性反省和感性反省 & 相近匹配 & 想像力](#废弃hn--分裂理性反省和感性反省--相近匹配--想像力)
  ...
  - [n25p23 TCSolution支持多fo综合稳定性评价](#n25p23-tcsolution支持多fo综合稳定性评价)
...
|  | 1. 将相近度乘进稳定性中; |
|  | 2. 然后所有的稳定性再求平均值,即为:最终稳定性; |
| 步骤3 | 得出稳定性后,最后取解决方案; |
|  | 问题: 多fo稳定性得出了,从哪个fo取解决方案? |

| 25233 | 多fo稳定性综评-实践分析2-两步稳定性 |
| --- | --- |
| 原则 | 评分主要作用于偏认知期,而决策期主要还是看稳定性; |
...
|  | > 如果第1步改成多fo构建任务,则不必再找等价fo,直接从rDemand取即可; |
