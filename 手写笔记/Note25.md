...
| 25131 | FZ39BUG_RSolution取到坏经验 `T` |
| --- | --- |
...
| 结果 | 将3条改成`稳定性>0 && 时间来的急`的3条; |

| 25135 | 强化训练设计_增加SP经验 |
| --- | --- |
| 需求 | 现在SP强化不足,导致的各种像初学走路的幼儿一样,各种不确定行为; |
| 解决 | 设计加训或强化训练方式,对指定的步骤自动进行训练; |

| 25136 | hSolution半途而废的BUG |
| --- | --- |
