...
>
> GNOP是连接thinking与net的桥,是smg研发中经历的第三大难题;
>
> 本章的难点是`一`,即`定义`;
>
...
| ![](assets/37_thinking信息流.png) |
| --- |
| 拆分thinking.commitInput()方法,按功能块拆成数个方法; |
...
| 宏微的怀疑 >> |
| --- |
| 1. 大脑是电信号,计算机是0和1,故smg不需要考虑微观; |
| 2. smg中的微观只是thinking拆分,`如:abcab中的ab` |
