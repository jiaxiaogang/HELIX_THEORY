...
2. 后来三次竞争 (参考26194&26195);
  * 后发现TC数据流过渡转化的不太好 (参考2619b);
3. 然后想分析下TC数据流改成决策期先筛后排 (参考2619f-原则4);
  * 但无论先筛哪个都有可能片面 (参考2619f-原则4-弃);
4. 再然后就是本文,希望找出决策期TC数据流更通畅的过度竞争;
