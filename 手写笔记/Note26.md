...
| --- | --- | --- | --- | --- |
| V识别 | near |  | 入 |  |
| A识别 | sumVNear/matchCount | 匹配度>0.9 | 入(具->抽) | 抽具感理 |
| F识别 | sumAMatch/cutIndex*稳定性 | 稳定性>0.4 | 入(具->向) | 抽具感 |
...
| 4 | 而是识别到抽象危险,然后再到具象二次匹配预测,得出不危险的结果; |
...
| TODO3 | 将时序识别的rFos关掉 (参考2619i-改2-3); |
