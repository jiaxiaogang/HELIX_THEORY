...
| 19071 | 理性三步 | 简述 | 算法 |
| --- | --- | --- | --- |
| 1 | TIR识别 | 简单识别成功 | TIR_Alg_Mem |
| 2 | TOR决策 | 用识别的M和原Proto,在M和P间取各自优势; | MC_Alg&MC_Value |
| 3 | TIR反思 | 更加全面的反思识别RTAlg,并使决策更准确; | TIR_Alg_RT |

| 19072 | 三者特性表 | 向性 | 数据量 | 作用 | 数据 |
| --- | --- | --- | --- | --- | --- |
| 1 | TIR识别 | 上 | 少 | 简单预测其用 | M |
| 2 | TOR决策 | 下 | 中 | 照顾所有信息 | M+P |
| 3 | TIR反思 | 上 | 多 | 全面反思评价 | 全面M |

| 19073 | TIR,TOR识别对比 | 原则 | 特征 |
| --- | --- | --- | --- |
| 1 | TIR | 向上注定丢失细节 | 收束,粗略识别并预测 |
| 2 | TOR | 向下注定要照顾细节 | 展开,是对原有粗略的见解进行详尽的展开和评价; |

| 19074 | TODO |
| --- | --- |
| 1 | MC_Value,需要操作(类比与反思)P并反思P的所有稀疏码; |
| 2 | 如MC_Value操作P,那么TIR_Alg_RT,就需支持模糊匹配,否则很难反思成功; |
| 3 | TIR_Alg_RT应该支持`Self`,`Fuzzy`,`全面的Match`,`Seem`四种识别; |
