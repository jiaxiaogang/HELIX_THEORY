...
> #### 感觉的知识表示
>
> 1. 感觉的知识表示是表达一切的值或傅利叶变换值。
>
> #### 感觉知识表示的要素
> 1. 不可逆向`(FLV不能逆向FLT)` `(类似md5)`
> 2. 与FLT按时间线对应性`(如音乐,或抛物线)`
> 3. FLV的值是每一位有限性的;`如每一位有0-9十个数字,则每一维指向10个下层`
>
> #### 难点:
...
> #### 神经网络的一个维度:
> 
> 1. 每一个节点(包括意识流和抽象节点和某段网络的抽象节点)都有一个值化(AIPoiner || 其它编码值)，的网络纬度，帮助感觉系统迅速找到似曾相识的感觉。
> 
> #### 问题1：
> 1. 感觉系统是否提供了一种在海量数据中快速检索的方式？
>
> > **分析实例:**
> >
> > 1. 人脑识别人脸的速度
