...
- [继续多码特征 & 自适应粒度迭代 & 组特征自举迭代](#继续多码特征--自适应粒度迭代--组特征自举迭代)
  ...
  - [n35p15 继续往回测之：测GT识别准确情况](#n35p15-继续往回测之测gt识别准确情况)
...
## n35p15 继续往回测之：测GT识别准确情况
`CreateTime 2026.01.17`

上节35141修了ST识别竞争因子，本节继续测下GT识别的准确情况。

| 35151 | 先测下GT识别准确情况（参考上节末小结） |
| --- | --- |
...
| 方案3 | ref时就修的更准些：别用assST来refGT，而是用类似bestGVs的那些absST来refGT。 |
...
| 抉择 | 如上，选定方案3.1。 |
| TODO1 | ST识别不需要防过具了，因为反正GT识别时还要向上取有效抽象。 |
| TODO2 | 把其ST的抽象度（匹配率）参与到GT识别竞争中来。 |
