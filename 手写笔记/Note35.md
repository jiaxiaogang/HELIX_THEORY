...
- [继续多码特征](#继续多码特征)
  ...
  - [n35p02 认知特征细节之：自适应多粒度](#n35p02-认知特征细节之自适应多粒度)
...
| 反方 | 应该继续方案v1以assT.content和rects来自举切粒度。 |
...
| 正方 | 以当前gv的protoScale和refLevel，依次确定切下一个assT.gv在proto中的合适粒度 (废弃现特征识别算法中的固定deltaLevel)。 |
