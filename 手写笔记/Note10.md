...
- [思维与神经网络整合开发实践](#思维与神经网络整合开发实践)
	...
	- [n10p6 数据网络-构建](#n10p6-数据网络-构建)
	- [n10p7 规则思想总结](#n10p7-规则思想总结)
	- [n10p8 归纳结构-正文](#n10p8-归纳结构-正文)
	- [n10p9 ActionControl的增删改查](#n10p9-actioncontrol的增删改查)
	- [n10p10 `抽象节点的理解` 与 `准确检索定位`](#n10p10-抽象节点的理解-与-准确检索定位)
	- [n10p11 `分维` 与 `归纳结构` 选用规则](#n10p11-分维-与-归纳结构-选用规则)
...
| 缺点 | 导致某些节点的老结构遗留,导致`思维时`发现结构冲突需要作结构更新; | 有时维间关联弱导致检索困难 |
...
| 归纳结构_dataType >> |  |
| --- | --- |
| char,arr | 不会有字符串维,思维的拆分,总会把字符串拆分成charArr传递给Net |
