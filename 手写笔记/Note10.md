...
- [思维与神经网络整合开发实践](#思维与神经网络整合开发实践)
	...
	- [n10p9 抽象节点的理解与准确定位](#n10p9-抽象节点的理解与准确定位)
...
|  | 懒构建部分 | 先天构建部分 |
| --- | --- | --- |
| 概念 | 思维类比分析到的部分,进行结构化(先天指定的) | 基础dataType定义部分,可先天指定结构构建(Net多维) |
...
| --- | --- |
| 矛盾 | 不识别无法检索,不检索无法识别 |
| 拆分多维检索 | 所以在神经元算法结果之处，便全了分维与各维独立优化。拆分多维检索有效提高速度 |
