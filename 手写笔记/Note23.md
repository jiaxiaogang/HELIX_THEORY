...
- [九测(融合训练)](#九测融合训练)
  ...
  - [n23p05 九测2-觅食防撞融合训练 (内中外类比v4 & getInnerV3回测)](#n23p05-九测2-觅食防撞融合训练-内中外类比v4--getinnerv3回测)
...
## n23p05 九测2-觅食防撞融合训练 (内中外类比v4 & getInnerV3回测)
`CreateTime 2021.04.23`

| 23051 | 获取不到GL问题回测 |
| --- | --- |
| 1 | 测得,PM评价`向→不通过`,明天再重新训练觅食,试下能否复现; |
