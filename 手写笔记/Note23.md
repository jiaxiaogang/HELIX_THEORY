...
| 方案1 | 如图,F11是另外两个任务的抽象,当F230失败时可尝试从抽象F11找dsFo; |
|  | 说明: 采用抽象的普适性,就必然面对更差的稳定性,代入示例分析下此问题; |
...
|  | 方案1足以解决当下F230无计可施的问题,所以方案2先不做 `以后再做` |
