...
| 方案1 | 把GT识别自举算法，改为assGT.itemST全含absST。 |
| 方案2 | 判断全含性能太差了，直接判断mIsC即可，即：assGT.itemST抽象指向absST。 |
| 抉择 | 1、有可能mIsC不成立，但其实全含是成立的，所以方案2性能好但不那么可靠，方案1可靠但性能差。 |
