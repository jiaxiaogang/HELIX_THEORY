...
| 结果 | 测得下表问题，先继续迭代下类比再测。 |

| 36033 | GT类比亦需降维至GV |
| --- | --- |
| 简介 | 上表测试时，测得需先完善下上节遗留的细节问题：GT类比也得降维到GV来完成。 |
...
| TODO1 | GT类比时，先把ST类比下（用stGroup.bestGVs来做ST抽象）。 |
| TODO2 | 这样的话根据assGT取有效抽象validAbsGT，也得降维判断到bestGVs来取。 |
