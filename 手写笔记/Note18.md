...
- [测试 & 细节改动 & 训练](#%E6%B5%8B%E8%AF%95--%E7%BB%86%E8%8A%82%E6%94%B9%E5%8A%A8--%E8%AE%AD%E7%BB%83)
  ...
  - [n18p10 思维控制器协作迭代](#n18p10-%E6%80%9D%E7%BB%B4%E6%8E%A7%E5%88%B6%E5%99%A8%E5%8D%8F%E4%BD%9C%E8%BF%AD%E4%BB%A3)
...
| 5 | 在外类比中,对时序的有序性做处理; (原先的类比是无序的类比方式) |  |
...
1. 习得absFo[坚果,吃]->{饱}
  1. 运行->直投
  2. 再运行->直投
  3. 调试可视化中,看到"外类比C2"时序节点,并符合相应内容;
2. 习得`远果不能吃`
  1. 远投
...
>
> ###### 本节说明:
> 　　在以往偏感性思维时，he中很多思维都是以TIP和TOP来触发的。但在过去半年迭代了更加理性的思维后，以感性来触发变得越来越不合适。本文将以此问题为切入，思考he中四个思维控制模块间的协作，主旋律是从TP触发向TR触发转变。
...
| 3 | 新的mv输入到TIP后,仅做demandManager的更新,而不做决策; |
| 4 | 而在TIR后,再进行识别预测,并转至TOR进行决策; |
