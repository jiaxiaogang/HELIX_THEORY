...
| todo3 | 从下面: 选个方案,计算出protoAlg中各个特征的强度值 |
...
|  | 结果: 最终选定方案4,因为最简单,精度上也没啥明显的问题,可以接受; |
| todo5 | 某个v重要性 = 某个v强度值 / 平均强度值; |
|  | todo5.1 某个v强度值 = 按todo4曲线,相邻上下个值连线求出 |
|  | todo5.2 平均强度值 = 总强度值 / 总conFo数 |
