...
| --- | --- |
| 日志 | 首次飞躲失败时: `> newS 第x例: eff:H1N0 sp:{1 = S0P2;2 = S2P0;} Father:F109 F1412` |
|  | 再次飞躲失败时: `> newS 第x例: eff:H1N0 sp:{1 = S0P3;2 = S2P0;} Father:F109 F1412` |
| 说明 | 问题说明: 由日志可见,第1次F1412方案失败后,第二次失败时effN一直是0,没+1; |
| 现状 | 经查,在rEffect()中,对IF两层及其各自的抽象指向,全更新统计了eff,但为什么日志上显示没统计上呢?待继续查; |
