...
- [回测防撞训练 & 继续觅食训练](#回测防撞训练--继续觅食训练)
  ...
  - [n29p02 共同点抽象](#n29p02-共同点抽象)
  - [n29p03 共同点抽象2](#n29p03-共同点抽象2)
...
1. 但场景不包含帧的Canset类比未写,转下面两张继续深入分析一下
2. 决策也没写,转实测时边测边明确了需求时再跟着写;
...
| --- | --- |
| todo1 | 直接构建空概念当抽象; |
| todo2 | 新空概念的具象指向3a,3b; |
| todo3 | 新空概念的抽象指向`共同抽象集`; |
| todo4 | 新空概念的的ds=共同抽象集pointerIdArr; |
