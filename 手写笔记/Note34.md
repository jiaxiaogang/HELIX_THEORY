...
| TODO1 | 把step1Model的可视化改成一个itemAbsT一幅。 |
| TODO2 | 可视精度：把可视化支持每个GV解析出来三索引值，用于推断出9宫色值，然后可视化。 |
| TODO2.1 | 可视精度的子级优先级大于父级，所以先推断父级色值，再推断子级，如果父级有的色值子级又有，则用子级的。 |
| TODO3 | 可视色彩：把可视化支持每个HSB合一显示，即用HSB三个值，合成一个最终色值，然后再显示成可视化。 |
