...
* B组: 远果不能吃
  ...
  - 饿
    ...
    STEPKEYF11[A10(速0,宽5,高5,形2.5,距0,向→,红0,绿255,蓝0,皮0),A1(吃1)]->M7{64}
    STEPKEYF13[A7(速0,宽5,高5,形2.5,向→,红0,绿255,蓝0,皮0,距46,经202,纬508)]->M8{-51
    --> M.PS节点 A1(距0)
    --> P.PS节点 A1(距46,经202,纬508)
    ---> 反向反馈类比 ms:A1(距0),A1(吃1) ps:A1(距46,经202,纬508)
