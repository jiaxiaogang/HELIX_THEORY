...
| TODO1 | 调试: 可以类比时,把抽象层级记录到foNode里,然后使用时把抽象层级打出来方便调试; |
| TODO2 | 查为什么Canset类比触发的少? (如果每反馈成功，canset实时竞争都大几率变一条,这导致类比太少?); |
...
| 说明 | 其实现在大致也是同效类比的,只是加了besting的判断,看来,还是 |
