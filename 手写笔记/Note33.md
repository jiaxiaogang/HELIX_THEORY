...
- [(觅食 & 飞躲 & 踢搬运)三项的多向连续训练,以及三项融合训练](#觅食--飞躲--踢搬运三项的多向连续训练以及三项融合训练)
  ...
  - [n33p09 通过继续FZ1003试错训练,回测以上三大改动](#n33p09-通过继续fz1003试错训练回测以上三大改动)
  - [n33p10 回顾多向觅食训练之: 继续FZ1003试错训练](#n33p10-回顾多向觅食训练之-继续fz1003试错训练)
...
## n33p09 通过继续FZ1003试错训练,回测以上三大改动
...
## n33p10 回顾多向觅食训练之: 继续FZ1003试错训练
`CreateTime 2024.10.11`

上节中,又修了两个BUG,本节继续试错训练,看还有没啥问题;

| 33101 | 重新跑下FZ1003试错训练,观察日志,看有没啥问题; |
| --- | --- |
