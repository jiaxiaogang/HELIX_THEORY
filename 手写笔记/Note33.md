...
| 调试 | 经查,所有solution输出的结果全是`[CUT:0=>TAR:5]`, |
...
|  | R0. I by:FROM<F9924 F302 F4777[↑饿-16,4,4果,飞↗,4果]> {0 = 0;} {0 = S0.00P1.00;3 = S0.00P1.00;2 = S0.00P1.00;5 = S0.00P2.00;1 = S0.00P1.00;4 = S0.00P1.00;} (分:1.00 P值:6) [CUT:0=>TAR:5] |
|  | R1. I by:FROM<F9924 F302 F8343[↑饿-16,4果,4果,飞↗,4果]> {0 = 0;} {0 = S0.00P1.00;3 = S0.00P1.00;2 = S0.00P1.00;5 = S0.00P2.00;1 = S0.00P1.00;4 = S0.00P1.00;} (分:1.00 P值:6) [CUT:0=>TAR:5] |
|  | R2. I by:FROM<F9924 F302 F3521[↑饿-16,4果,飞↖,4果]> {0 = 0;} {0 = S0.00P1.00;3 = S0.00P1.00;2 = S0.00P1.00;1 = S0.00P1.00;4 = S0.00P2.00;} (分:1.00 P值:5) [CUT:0=>TAR:4] |
| 思路 | 可以先查下,为什么排前面的全是CUT0,或者为什么只有CUT0才排到前面? |
