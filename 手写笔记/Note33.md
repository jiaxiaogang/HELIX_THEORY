...
- [(觅食 & 飞躲 & 踢搬运)三项的多向连续训练,以及三项融合训练](#觅食--飞躲--踢搬运三项的多向连续训练以及三项融合训练)
  ...
  - [n33p11 时序识别似层化 & 迭代迁移](#n33p11-时序识别似层化--迭代迁移)
...
| TODO2 | 反馈时,具象计SP,抽象中凡有映射的,同时也计下SP; |
...
| TODO3 | 每次canset计SP+1时,推举到所有F层也累加1; |
...
| TODO1 | 所有I和F层的SP各计各的,不继承 (包括迁移时,也不初始继承spDic,及今后F的增强,全不同步到I层); |
