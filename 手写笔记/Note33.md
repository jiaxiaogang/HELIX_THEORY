...
- [(觅食 & 飞躲 & 踢搬运)三项的多向连续训练,以及三项融合训练](#觅食--飞躲--踢搬运三项的多向连续训练以及三项融合训练)
  ...
  - [n33p15 H迁移延着R迁移关联进行（旧做法是延着R场景树）](#n33p15-h迁移延着r迁移关联进行旧做法是延着r场景树)
...
## n33p15 H迁移延着R迁移关联进行（旧做法是延着R场景树）
`CreateTime 2025.01.08`

上节测试修了许多BUG，但又测到hSolution总是无计可施问题，本节在这个BUG上，迭代H的迁移。
...
| 33155 | 接33152-迭代hSolutionV4 |
| --- | --- |
| TODO1 | 迭代hSolutionV4，延着RCanset的迁移关联，找到并继承hCanset。 |
| TODO2 | HCanset的Xv迁移，也得延着RCanset的迁移关联进行。 |
