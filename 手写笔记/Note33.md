...
- [(觅食 & 飞躲 & 踢搬运)三项的多向连续训练,以及三项融合训练](#觅食--飞躲--踢搬运三项的多向连续训练以及三项融合训练)
  ...
  - [n33p07 打开反思子任务: 迭代TCPlan支持反思子任务](#n33p07-打开反思子任务-迭代tcplan支持反思子任务)
...
## n33p07 打开反思子任务: 迭代TCPlan支持反思子任务
...
| --- | --- |
| 名词 | 派生任务: 今后把这种反思识别预测到的子任务,称为派生任务,因为它更是另一个标识的任务,所以改名叫派生任务; |
...
| TODO1 | 派生任务要挂在baseCansetFo下; |
|  | 作用: 为了下次反思时复用等方便&也为了通过root.baseOrGroup说明它是派生任务; |
| TODO2 | 派生任务也要挂在loopCache中; |
|  | 作用: 为了在TCPlan中,做root竞争时,它能够同台竞争; |
| TODO3 | 派生任务的解在有推进时,说明派生任务不那么严重了,要削弱它的任务评分,而不是像以前的root那样加强; |
| TODO4 | 如果触发了重新反思,那么旧的几条派生任务要先从loopCache中移除掉; |
| 疑问转折 | 如果base没激活呢?派生任务还有和别的root同台竞争的机会吗? |
|  | > 答: base都不激活了,派生任务自然也就不应该激活了; |
|  | > 如: 翻山遇老虎危险,突然想到还有条水路可走,自然就不必再准备猎枪了; |
| 结果 | 根据以上疑问转折,派生任务还是挂在baseFo下即可,不必加到loopCache下与root同台竞争 `转33072继续`; |
...
| 需要改 | 不过需要把TCPlanV2改进下,再让它支持子R任务; |
