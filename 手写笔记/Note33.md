...
| 补充 | 后发现,本表BUG修复后,应该重新训练下第二步 `转33104 T`; |
...
| 结果 | 所以转33104,重新训练下FZ1002 `T 转下表`; |

**小结: 以上测两点之二: 测有向无距果场景在竞争中慢慢浮现不顺利,经分析需要重训练第2步 `转下表 T`;**

| 33104 | 重新训练FZ1002为FZ1012; |
| --- | --- |
| 步骤 | 认知模式:`饿,扔附近坚果,随机连飞3下(如飞中吸吮反射)`x100轮 (参考28173-2学飞); |
| 结果 | 在FZ981基础上,截入RL工具的第二步:学吃,并训练跑完 `存为FZ1012`; |
