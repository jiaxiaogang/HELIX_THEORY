...
| TODO3 | 子R任务的解在有推进时,说明子R任务不那么严重了,要削弱它的任务评分,而不是像以前的root那样加强; |
| TODO4 | 如果触发了重新反思,那么旧的几条子R任务要先从loopCache中移除掉; |
...
| TODO3 | R子任务的前提是父任务,它不必做预测 (只要父任务的推进,就是子任务跟着推就行) `转33073 T` |
| TODO4 | 但像拍一下篮球这种小任务,每一个动作都反思下尚可,但R子任务再求解下,确实来不及 `转33074 T`; |
