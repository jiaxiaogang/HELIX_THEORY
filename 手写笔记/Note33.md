...
```java
33051-分析代码段1
Canset演化> NewRCanset:F14608[M1{↑饿-16},A14593(距10,向272,果),A51(,果),A14593(距10,向272,果),A14593(距10,向272,果),A14593(距10,向272,果),A14593(距10,向272,果),飞↓,A14604(距0,向276,果)] toScene:F9331[↑饿-16,2果] (原因:持续任务反馈正mv)
----------- 外类比(普) -----------
fo:F14608[M1{↑饿-16},A14593(距10,向272,果),A51(,果),A14593(距10,向272,果),A14593(距10,向272,果),A14593(距10,向272,果),A14593(距10,向272,果),飞↓,A14604(距0,向276,果)]
assFo:F10119[飞←,A10078(距12,向273,果),A10063(距12,向263,果),M1{↑饿-16},A51(,果),飞↓,A10090(距0,向252,果)]
proto的第8: A14604 类比 ass的第6: A10090 (失败)
proto的第8: A14604 类比 ass的第5: A1609 (失败)
proto的第8: A14604 类比 ass的第4: A51 (成功)
alg类比 ===> A14604(距0,向276,果) : A51(,果) = A51(,果)
proto的第7: A1609 类比 ass的第3: A1 (失败)
proto的第7: A1609 类比 ass的第2: A10063 (失败)
proto的第7: A1609 类比 ass的第1: A10078 (失败)
proto的第7: A1609 类比 ass的第0: A1657 (成功)
> 当前A1609<飞↓>比A1657<飞←>的缺口:0.50 / 总缺口0.50 = 当前责任1.00
alg类比 ===> 飞↓ : 飞← = A2038()
1. 新proto: F14608[M1{↑饿-16},A14593(距10,向272,果),A51(,果),A14593(距10,向272,果),A14593(距10,向272,果),A14593(距10,向272,果),A14593(距10,向272,果),飞↓,A14604(距0,向276,果)]
2. 与ass: F10119[飞←,A10078(距12,向273,果),A10063(距12,向263,果),M1{↑饿-16},A51(,果),飞↓,A10090(距0,向252,果)]
3. 外类比构建时序: F10176[A2038(),A51(,果)]->{} from: (protoFo(1):assFo(4))
Canset演化> AbsRCanset:F10176[A2038(),A51(,果)] from(F14608:F10119) toScene:F9331[↑饿-16,2果]

问题: 查下,这两个类比后,为什么没有`飞下`;
分析:
1. 这里的前段,本来就有indexDic,应该不能单纯以是否mIsC来判断,在迁移算法执行时,它的indexDic已经前段有映射了;
2. 查下,这里assFo是cansetFrom还是cansetTo,因为现在是针对sceneTo在生成新的解,所以应该使用cansetTo才对;
3. 这里即使最后一帧`无距果`互相之间没有mIsC关系,也不应该跳过`飞下` (感觉应该从前往后类比,还是从后往前);
TODOTOMORROW20240911: 明天继续深入到代码中,查线索,找出修复方法;
```
