...
| 22052 | 代码规划 |
| --- | --- |
| 1 | 输入当前帧matchFo到末位的,改变状态为Wait,并增加生物钟触发器; |
|  | a. 在TIR_FoFromShortMem中,对HNGL和Normal两种情况单独判断; |
| 2 | OPushM时,对Wait中的进行匹配判断,并做状态改变为OutBack; |
| 3 | 对生物钟触发器触发时,未OutBack的,进行反向反馈类比,构建SP; |
