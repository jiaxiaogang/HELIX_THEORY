# v2.0版本六测 & 评价器 & R-模式迭代 & 七八测-防撞训练 & 子任务 & 来的及评价
...
- [v2.0版本六测 & 评价器 & R-模式迭代 & 七八测-防撞训练 & 子任务 & 来的及评价](#v20版本六测--评价器--r-模式迭代--七八测-防撞训练--子任务--来的及评价)
  ...
  - [n22p19 来的及评价 & 子任务](#n22p19-来的及评价--子任务)
  - [TODOLIST](#todolist)
...
参考22155,静默成功中的mIsC判断太不理性,太局限了,所以本节将其改为`来的及`评价;
...
| 3. 子任务`决策流程`: alg来的及时actYes即成功,规划决策处理; |  |
| 4. 子任务`决策流程`: alg来不及时即失败 (原有HNGL等失败逻辑不变); |  |
