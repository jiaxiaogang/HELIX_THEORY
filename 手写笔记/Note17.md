...
- [V2.0的测试/训练/细节完善/理性思维](#v20%E7%9A%84%E6%B5%8B%E8%AF%95%E8%AE%AD%E7%BB%83%E7%BB%86%E8%8A%82%E5%AE%8C%E5%96%84%E7%90%86%E6%80%A7%E6%80%9D%E7%BB%B4)
  ...
  - [n17p19 TOR回归感性评价](#n17p19-tor%E5%9B%9E%E5%BD%92%E6%84%9F%E6%80%A7%E8%AF%84%E4%BB%B7)
  - [TODOLIST](#todolist)
...
| --- | --- |
| 1. 复查下`概念有无`的代码,看是否需要改动; |  |
| 2. 根据时序来解决,`变化`的问题,或使用当下更简单的`内类比大小`来解决; |  |
| 3. 将matchAlg融入到行为化中,提供`有`; |  |
| 4. 恢复概念嵌套; |  |
...
| 理性评价 >> |
| --- |
| 注: 在TOP中,没吃过带皮坚果,所以根本不会有`fo[吃,带皮坚果]`传给的`行为化总入口`; |
| 注2: 所以此处主要针对MC匹配中导致的`不能吃`做评价: |
| ![](assets/194_行为化fo的理性评价.png) |
| 图示说明: cFo为相对时序时,对MC找到的mAlg,做同样相对时序的联想,然后判断,能否找到一样的经历; (如吃过坚果,没吃过带皮坚果) |

| 行为化fo的感性评价 >> |
| --- |
| ![](assets/193_行为化fo的感性评价.png) |
| 图示说明: MC里氏可换时,对c所在的cFo.conPorts,找含有m的mFo,以mFo.mv作为评价指标 |
