...
- [V2.0的测试/训练/细节完善/理性思维](#v20%E7%9A%84%E6%B5%8B%E8%AF%95%E8%AE%AD%E7%BB%83%E7%BB%86%E8%8A%82%E5%AE%8C%E5%96%84%E7%90%86%E6%80%A7%E6%80%9D%E7%BB%B4)
  ...
  - [n17p2 TOR(ThinkOutReason)2](#n17p2-torthinkoutreason2)
  - [n17p3 TIR-理性预测](#n17p3-tir-%E7%90%86%E6%80%A7%E9%A2%84%E6%B5%8B)
  - [TODOLIST](#todolist)
...
| --- | --- |
| 1. 认知 `学习` `I` `←` `↑` | 不解释 |
| 2. 识别 `预测` `I` `→` `↑` | 从具象识别为抽象,分为概念识别和时序识别; |
| 3. 决策 `行为` `O` `←` `↓` | 不解释 |
| 4. 比对 `修改` `O` `→` `↓` | 从抽象向具象修正,来达成或避免某价值变化; |
