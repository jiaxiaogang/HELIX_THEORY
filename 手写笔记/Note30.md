...
| 实践 | 分析下怎么实现在[饿]->{饿}下,生成无向无距果的rCanset经验,规划为训练步骤: |
...
| 2> | 然后为此制定一下训练步骤 |
|  | todotomorrow: 主要测下,过度抽象的scene下,各样的rCanset之间的识别类比,会产出什么? |
...
|  | 前提: 无论是无皮果还是有皮果,都要先训练至: 其能够稳定识别到无距向的,然后再去训练rScene->rCanset->absRCanset->hCanset这一套,才能跑顺当; |

**小结: 本表测得问题为hCanset激活不顺利,问题说明: 因为rScene极度抽象,导致rCanset非常多,有h经验的rCanset大几率没机会激活,导致hCanset就更加激活不到了**
