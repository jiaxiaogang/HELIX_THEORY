...
| 步骤 | 动物模式: `FZ884,饿,路边出生,路上就近扔带皮果,扔棒去皮,手动飞过去,触发吃掉` |
| 结果1 | 试了一下,跑出日志: `tempLogPrerfix RCanset预想与实际类比未执行,F9092 状态:3` |
|  | 分析: 明天解读一下日志,看下是不是有rCanset的执行,然后又有新canset,准备要调用二者类比了; |
