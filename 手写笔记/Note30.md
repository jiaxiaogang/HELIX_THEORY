...
TODOTOMORROW20231011:
1、测下训练FZ884后hCanset是否构建到了。
...
P-->>>(680) 全含item: A4093(向22,距105,棒)   	相近度 => 0.85 (count:4)
P-->>>(620) 全含item: A3959(向42,距52,棒)   	相近度 => 0.87 (count:4)
P-->>>(552) 全含item: A3830(距40,向36,棒)   	相近度 => 0.86 (count:4)
P-->>>(552) 全含item: A4785(距110,向14,棒)   	相近度 => 0.80 (count:4)
P-->>>(376) 全含item: A4730(距61,向46,棒)   	相近度 => 0.87 (count:4)
P-->>>(280) 全含item: A4708(距50,向53,棒)   	相近度 => 0.80 (count:4)
P-->>>(264) 全含item: A4850(距40,向37,棒)   	相近度 => 0.86 (count:4)
P-->>>(196) 全含item: A5758(距69,向38,棒)   	相近度 => 0.92 (count:4)
P-->>>(148) 全含item: A7010(向15,距95,棒)   	相近度 => 0.85 (count:4)
P-->>>(132) 全含item: A7311(距79,向17,棒)   	相近度 => 0.91 (count:4)
P-->>>(104) 全含item: A6893(距48,向48,棒)   	相近度 => 0.82 (count:4)
P-->>>(92) 全含item: A7033(向43,距43,棒)   	相近度 => 0.83 (count:4)
P-->>>(88) 全含item: A7103(距51,向29,棒)   	相近度 => 0.93 (count:4)
P-->>>(36) 全含item: A7364(向18,距103,棒)   	相近度 => 0.84 (count:4)
P-->>>(16) 全含item: A7522(向17,距78,棒)   	相近度 => 0.91 (count:4)
P-->>>(12) 全含item: A6985(向33,距41,棒)   	相近度 => 0.88 (count:4)
...
R-->>>(1012) 全含item: A3293(向342,距76,棒)   	相近度 => 0.73 (count:4)
R-->>>(1000) 全含item: A2633(距98,向20,棒)   	相近度 => 0.86 (count:4)
R-->>>(784) 全含item: A3154(距77,向24,棒)   	相近度 => 0.95 (count:4)
R-->>>(548) 全含item: A2927(向47,距38,棒)   	相近度 => 0.80 (count:4)
R-->>>(528) 全含item: A3326(距49,向48,棒)   	相近度 => 0.83 (count:4)
R-->>>(512) 全含item: A3000(距61,向25,棒)   	相近度 => 0.99 (count:4)
R-->>>(196) 全含item: A3458(向26,距74,棒)   	相近度 => 0.96 (count:4)
...
```c
////以下从识别,预测,任务,求解,推进,都没啥问题,,,
//但问题是,这套太6的流程,和上面的问题没啥关系,随机整理,现在实在没时间了...
=============================== 2 概念识别 ===============================
A9830(距96,向128,皮果)
概念识别结果 (28条) protoAlg:A9830(距96,向128,皮果)
P-->>>(1056) 全含item: A197(向136,距101,皮果)   	相近度 => 0.94 (count:4)
P-->>>(1408) 全含item: A2016(距98,向155,皮果)   	相近度 => 0.84 (count:4)
P-->>>(1156) 全含item: A329(向156,距93,皮果)   	相近度 => 0.84 (count:4)
P-->>>(1448) 全含item: A18(距87,向168,皮果)   	相近度 => 0.75 (count:4)

=============================== 2 识别二次过滤 ===============================
from protoFo:F9832[M1{↑饿-16},A9830(距96,向128,皮果)]
重要性结果:  = 12.674;  = 21.233; 距96 = 3.817; 向128 = 0.579;
概念二次过滤后条数: 原28 剩4 >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
时序二次过滤后条数: 原15 剩4 >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
	1. F200[M1{↑饿-16},A197(向136,距101,皮果)]
	2. F2019[M1{↑饿-16},A2016(距98,向155,皮果)]
	3. F332[M1{↑饿-16},A329(向156,距93,皮果)]
	4. F21[M1{↑饿-16},A18(距87,向168,皮果)]

=============================== 2 rDemand ===============================
energy > newValue:317.71 = energy:20.00
RMV新需求: 饿 (条数+1=2 评分:-15.885659)
	 pFo:F200[M1{↑饿-16},A197(向136,距101,皮果)]->{-16.00} SP:{0 = S0P31;1 = S0P31;2 = S31P0;} indexDic:{0 = 0;1 = 1;}
	 pFo:F332[M1{↑饿-16},A329(向156,距93,皮果)]->{-16.00} SP:{0 = S0P74;1 = S0P74;2 = S74P0;} indexDic:{0 = 0;1 = 1;}
	 pFo:F21[M1{↑饿-16},A18(距87,向168,皮果)]->{-15.88} SP:{0 = S0P129;1 = S0P129;2 = S128P1;} indexDic:{0 = 0;1 = 1;}
	 pFo:F2019[M1{↑饿-16},A2016(距98,向155,皮果)]->{-15.67} SP:{0 = S0P48;1 = S0P48;2 = S47P1;} indexDic:{0 = 0;1 = 1;}
生成NewRoot数:1 from:F9832[M1{↑饿-16},A9830(距96,向128,皮果)]

=============================== 3 rSolution ===============================
任务源:饿 protoFo:F9832[M1{↑饿-16},A9830(距96,向128,皮果)] 已有方案数:0 任务分:-15.89
第1步 R场景树枝点数 I:4 + Father:12 + Brother:95 = 总:111
第2步 转为候选集 总数:7
第5步 Anaylst匹配成功:7
第6步 排除不应期:7
第7步 排除FRSTime来不及的:7
0. I<F200 F7391[M1{↑饿-16},A197(向136,距101,皮果),A6552(距121,向17,棒)]> {2 = S0P6;}:(分:1.00) H1N6:(分:0.14)
1. B<F200 F7391[M1{↑饿-16},A197(向136,距101,皮果),A6552(距121,向17,棒)]> {2 = S0P6;}:(分:1.00) H1N6:(分:0.14)
2. I<F21 F6656[M1{↑饿-16},A18(距87,向168,皮果),A6552(距121,向17,棒)]> {2 = S0P7;}:(分:1.00) H1N7:(分:0.12)
3. B<F21 F6656[M1{↑饿-16},A18(距87,向168,皮果),A6552(距121,向17,棒)]> {2 = S0P7;}:(分:1.00) H1N7:(分:0.12)
4. B<F21 F6656[M1{↑饿-16},A18(距87,向168,皮果),A6552(距121,向17,棒)]> {2 = S0P7;}:(分:1.00) H1N7:(分:0.12)

=============================== 3 TCTransfer迁移 =============================== fromI
迁移结果: iScene:F200 Canset:F7391[M1{↑饿-16},A197(向136,距101,皮果),A6552(距121,向17,棒)]
> newS 第1例: eff:H1N6 sp:{2 = S0P6;} I scene:F200 canset:F7391 (前0.94 中1.00 后1.00)
---//rEffect触发器新增:0x600001086e80 (Other | 触发时间:20.00)
---> 设定生物钟触发器: deltaTime:20.00 triggerTime:20.00


=============================== 3 行为化Fo ===============================
第 3/3 个,时序:F7391[M1{↑饿-16},A197(向136,距101,皮果),A6552(距121,向17,棒)]

=============================== 6 OR反省 ===============================
F7391[M1{↑饿-16},A197(向136,距101,皮果),A6552(距121,向17,棒)] spIndex:2 -> (好)
OR反省(好 第3帧)为rCanset:F7391[M1{↑饿-16},A197(向136,距101,皮果),A6552(距121,向17,棒)]...
 	> 生成hCanset:F9845[M1{↑饿-16},A197(向136,距101,皮果),A9833(距189,向12,棒)]
```
