...
| 30142 | 30142-方案: 学去皮训练 |
| --- | --- |
| 步骤1 | **带皮学饿: 认知模式,(`饿(持续饿感3次),扔随机带皮坚果,不吃,又饿` x 200轮) x 4次;** |
|  | 解析: 类似学饿,学会各视角下有皮果也会饿 (现有kick1BtnClick()强训代码可用,`参考30092`); |
| 步骤2 | **带皮学吃: 认知模式,(`饿,路边出生,路上就近扔带皮果,扔棒去皮,手动飞过去,触发吃掉`) x 上下各2次** |
|  | 解析: 即习得: `[饿,带皮果,棒撞果,无皮果,飞,吃]->{不再饿}`,(曾做过但没训成功,`参考30092`); |
|  | 重点关注: 在30093可见,当时是没训得H去皮经验,此次训练重点关注下"去皮hCanset"是否有形成; |
