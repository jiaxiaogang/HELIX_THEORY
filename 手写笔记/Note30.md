...
**小结: 以上是搬运训练的大岗,分成了两步: 1.去皮 2.搬运, 这两步下面详细展开来做;**
...
|  | 测试步骤2: `饿,上扔坚果` (它会自行飞过去吃掉,然后反省会对`饿了更饿`生成新canset) `日志参考30095代码段`; |
|  | 测试步骤3: `饿` (它应能找着步骤2时习得的吃果经验,并激活行为化); |

```js
//30095代码段: 此处为`30095-回测2-测试步骤2`反省得到Canset的日志;
=============================== 10 IP反省 ===============================
