...
| 训得问题 | 思维路径与预想不同问题: 但在顺利上飞吃到坚果时,激活absCanset的方式和原本想的不太一样; |
...
| ↓ | > 缺点: 此方案改动就大了,随后再说吧; |
| 训练方案1 | 见以上优缺点分析,暂选方案1,训练步骤: `FZ8604,饿,看日志H任务形成后,再扔坚果`; |
| 训得问题 | 发现H任务形成后,直接输出无计可施...这...回顾下H动机相关手稿.. |
|  | 并且,第二条H再次时,不形成了?还是不激活了; |
