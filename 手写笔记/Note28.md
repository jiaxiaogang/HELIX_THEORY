...
- [螺旋调教 & TCSolution前段条件满足迭代](#螺旋调教--tcsolution前段条件满足迭代)
  ...
  - [n28p07 测canset再类比很少 & S后段匹配度很低](#n28p07-测canset再类比很少--s后段匹配度很低)
...
| 所以 | 中段有效性需做成单独竞争器,不能单纯用到前中后的相乘中 `转28073`; |

| 28073 | cansetRank竞争器细化迭代-方案制定; |
| --- | --- |
