...
|  | 而具象场景有距离,它是否适用这个Canset,还是得具象场景的实际EFF来决定,既然如此: 那么我们还不如就在当前网络结构上做增强迁移性,不必依赖V和特征的分模块; |
...
|  | > 而真正迁移后的Canset还是迁移后的场景用protoFo生成新Canset; |
...
| --- | --- |
| todo1 | 将具象Canset记录到抽象matchFo下,写个absCansetArr; |
